...
var app = {
	...
	addToCal: function() {
			...
			var success = function() { alert("Success addToCal"); };
			var error = function(message) { alert("Oopsie addToCal! " + message); };
			calendar.createEvent(title, location, notes, startDate, endDate, success, error);
	},
	
	addBeacon: function() {
		var success = function() { alert("Success addBeacon"); };
		var error = function(message) { alert("Oopsie addBeacon! " + message); };
